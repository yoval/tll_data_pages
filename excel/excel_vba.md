...
Sub FilterByShengManager()
    ...
    For Each manager In managerList
        ...
        For Each ws In wb.Sheets
            If ws.PivotTables.Count = 0 Then
                success = FilterWorksheetByColumn(wb, ws, manager, 1, "省区经理")
                If Not success Then
                    success = FilterWorksheetByColumn(wb, ws, manager, 3, "省区经理")
                End If
            End If
        Next ws
